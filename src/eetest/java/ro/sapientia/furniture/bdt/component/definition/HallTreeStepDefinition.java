...
public class HallTreeStepDefinition{
	...
	public void that_we_have_the_following_furniture_bodies(final DataTable hallTreeBodies) throws Throwable {
		for (final Map<String, String> data : hallTreeBodies.asMaps(String.class, String.class)) {
			HallTreeBody body = new HallTreeBody();
			...
			body.setHangers(Integer.parseInt(data.get("hangers")));
			body.setHangedClothes(Integer.parseInt(data.get("hangedClothes")));
